...
export const images = {
	...
	lock: 'data:image/png;base64,',
	key: 'data:image/png;base64,',
...
export const keySprite = (itemState) => (track) => () => {
	const sprite = Sprite({
		type: 'key',
		x: itemState.x,
		y: itemState.y,
...
export const lockSprite = (itemState) => (track) => () => {
	const sprite = Sprite({
		type: 'lock',
		x: itemState.x,
		y: itemState.y,
